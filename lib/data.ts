...
function normalizePageContent(raw: PageContentMap): PageContentMap {
  ...
  return {
    ...
    homePage: {
      ...d.homePage,
      ...raw.homePage,
      everydayLabel: raw.homePage?.everydayLabel ?? d.homePage.everydayLabel,
      everydayHeadline: raw.homePage?.everydayHeadline ?? d.homePage.everydayHeadline,
      everydaySubhead: raw.homePage?.everydaySubhead ?? d.homePage.everydaySubhead,
      toolEmailTitle: raw.homePage?.toolEmailTitle ?? d.homePage.toolEmailTitle,
      toolEmailBlurb: raw.homePage?.toolEmailBlurb ?? d.homePage.toolEmailBlurb,
      toolContentTitle: raw.homePage?.toolContentTitle ?? d.homePage.toolContentTitle,
      toolContentBlurb: raw.homePage?.toolContentBlurb ?? d.homePage.toolContentBlurb,
      toolReportTitle: raw.homePage?.toolReportTitle ?? d.homePage.toolReportTitle,
      toolReportBlurb: raw.homePage?.toolReportBlurb ?? d.homePage.toolReportBlurb,
      allToolsCta: raw.homePage?.allToolsCta ?? d.homePage.allToolsCta,
      allToolsHref: raw.homePage?.allToolsHref ?? d.homePage.allToolsHref,
      newsLabel: raw.homePage?.newsLabel ?? d.homePage.newsLabel,
      newsLede: raw.homePage?.newsLede ?? d.homePage.newsLede,
      newsViewAll: raw.homePage?.newsViewAll ?? d.homePage.newsViewAll,
      articlesLabel: raw.homePage?.articlesLabel ?? d.homePage.articlesLabel,
      articlesLede: raw.homePage?.articlesLede ?? d.homePage.articlesLede,
      articlesViewAll: raw.homePage?.articlesViewAll ?? d.homePage.articlesViewAll,
      tickerItems: raw.homePage?.tickerItems ?? d.homePage.tickerItems,
    },
    teamPage: {
      meetHeadline: raw.teamPage?.meetHeadline ?? d.teamPage.meetHeadline,
      meetHeadlineEmphasis: raw.teamPage?.meetHeadlineEmphasis ?? d.teamPage.meetHeadlineEmphasis,
      footerStripTitle: raw.teamPage?.footerStripTitle ?? d.teamPage.footerStripTitle,
      footerStripCta: raw.teamPage?.footerStripCta ?? d.teamPage.footerStripCta,
      footerStripHref: raw.teamPage?.footerStripHref ?? d.teamPage.footerStripHref,
    },
    footer: {
      ...d.footer,
      ...raw.footer,
